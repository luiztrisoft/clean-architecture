package com.trisoft.cleanarch.entrypoint.consumer;

import com.trisoft.cleanarch.core.usecase.UpdateCustomerUseCase;
import com.trisoft.cleanarch.entrypoint.consumer.mapper.CustomerMessageMapper;
...
public class ReceiveValidatedCpfConsumer {
    ...
    @KafkaListener(topics = "tp-cpf-validated", groupId = "trisoft")
